...
* В используемом подходе к проектированию, можно отметить, во-первых, _иммутабельность внутренних
  абстракций_, ибо это облегчает как программирование, так и отладку. Во вторых, используется
  избирательное покрытие тестами лишь узких мест, по причине нежелания тестировать dto и модели 🙂
* Несмотря на _стремление к функциональному стилю_, данный подход больше подходит под определение _
  мультипарадигменного проектирования_, поскольку функциональные концепты не везде удачно
